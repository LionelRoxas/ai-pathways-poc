        ...
        <div className="max-w-3xl mx-auto px-6">
          <div
            className={`
              ...
              ${isFocused ? "ring-2 ring-emerald-600 shadow-2xl" : "shadow-md"}
            `}
          >
            {/* Input Area */}
            <div className="relative flex items-end">
              <textarea
                ...
                className="w-full border-0 rounded-2xl px-6 py-5 pr-16 focus:outline-none resize-none min-h-[64px] max-h-[160px] text-slate-900 placeholder-gray-400 bg-transparent text-base leading-relaxed"
                rows={1}
                disabled={isLoading}
              />
          ...
          <div className="max-w-4xl mx-auto bg-white px-4 py-1">
            ...
            <div
              className={`
                ...
                ${isFocused ? "bg-white ring-2 ring-emerald-600" : "hover:bg-gray-100"}
              `}
            >
              ...
              <div className="relative flex items-end">
                <textarea
                  ...
                  className="w-full border-0 rounded-xl px-4 py-3 pr-12 focus:outline-none resize-none min-h-[48px] max-h-[160px] text-slate-900 placeholder-gray-400 bg-transparent text-sm leading-relaxed"
                  rows={1}
                  disabled={isLoading}
                />
